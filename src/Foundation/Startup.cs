    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDAMUi(
                ...
                o => 
                    {
                        o.ClientSecret = _configuration["OptiDamGraph:ClientSecret"];
                        o.ClientId = _configuration["OptiDamGraph:ClientId"];
                    });
            ...
            services.AddJhooseOptiDamExtensions(_configuration);
        }
